...
<?php query_posts('pagename=content'); if (have_posts()) : the_post(); ?>
    ...
    <form id="ai-form" method="post" enctype="multipart/form-data">
      ...
      <input class="email email-karim hidden" type="checkbox" name="ai_sendTo" value="karim@adprime.pl">
      <input class="email email-relka hidden" type="checkbox" name="ai_sendTo" value="klaudia@adprime.pl">
